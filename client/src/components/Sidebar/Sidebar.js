...
import { getOpenMeausurePanel, setOpenMeausurePanel } from "../../features/measurements/measurementsSlice";
      ...
      <div className="scene__list">
        ...
        <div className="scene__panel">
          <div className="properties flex justify-between items-center">
            ...
            <SwitchIcon
              showIcon={openMeasurePanel}
              className="w-4 h-4 cursor-pointer"
              icon={minusIcon}
              altIcon="Minus"
              altIconSwitch="Plus"
              iconSwitch={plusIcon}
              onClick={() => dispatch(setOpenMeausurePanel(!openMeasurePanel))}
            />
          </div>
          {openMeasurePanel && <Panel type="measure" />}
        </div>
        <div className="scene__panel">
          <div className="properties flex justify-between items-center">
